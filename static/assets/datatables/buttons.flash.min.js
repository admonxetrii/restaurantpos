(function (f) {
    ...
    i.ext.buttons.excelFlash = f.extend({}, t, {
        ...
        text: function (a) {
            ...
            var a = c._flash, e = 0, g = f.parseXML(p["xl/worksheets/sheet1.xml"]),
                h = g.getElementsByTagName("sheetData")[0], d = {
    ...
    i.ext.buttons.pdfFlash = f.extend({}, t, {
        className: "buttons-pdf buttons-flash", text: function (a) {
            ...
            var a = c._flash, e = b.buttons.exportData(c.exportOptions), g = b.table().node().offsetWidth,
